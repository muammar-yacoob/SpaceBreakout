...
This project contains a simple Arkanoid/Breakout clone. 
Please refactor the project, taking into consideration the following key points:
...
The project has been designed with a 9:16 ratio in portrait mode.